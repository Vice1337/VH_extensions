...
-- toggle2
			function items:Toggles(side, text, callback)
				...
				TogglesFrameBack.Name = "TogglesFrameBack"
				...
				TogglesFrameBackCorner.Name = "TogglesFrameBackCorner"
				TogglesFrameBackCorner.Parent = TogglesFrameBack
				
				local TogglesFrameCircle = Instance.new("Frame")
				TogglesFrameCircle.Name = "TogglesFrameCircle"
